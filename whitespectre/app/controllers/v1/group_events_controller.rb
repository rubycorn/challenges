class V1::GroupEventsController < ApplicationController
  ...
  def create
    ...
    if @group_event.save
      render json: @group_event, status: :created, location: [:v1, @group_event]
    else
  ...
  def group_event_params
    params.require(:group_event).permit(:name, :duration, :start, :stop, :description, :latitude, :longitude, :draft)
  end
end
